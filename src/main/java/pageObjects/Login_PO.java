...
public class Login_PO extends Base_PO {
    ...
    public void navigateTO_WebDriverUniversity_Login_Page() {
        navigateTo_URL(Global_Vars.WEBSITE_BASE_URL + "/Login-Portal/index.html");
    }
    ...
    public void validate_SuccessfulLogin_Massage() {
      waitForAlert_And_ValidateText("validation succeeded");
    }

    public void validate_UnsuccessfulLogin_Massage() {
